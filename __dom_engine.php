...
function seotext($str) { $tago = str_replace(' ', '-', $str); $tago = preg_replace('/\\\\u([0-9a-fA-F]{4})/', " ", $tago); $tago = preg_replace('/[^\p{L}\p{N}\s]/u', " ", $tago); $tago = str_replace(".com", " ", $tago); $tago = str_replace("www.", " ", $tago); $tago = str_replace("&amp;", " ", $tago); $tago = str_replace("\\", " ", $tago); $tago = str_replace("–", " ", $tago); $tago = str_replace(".net", " ", $tago); $tago = str_replace("(", " ", $tago); $tago = str_replace(")", " ", $tago); $tago = str_replace("&", " ", $tago); $tago = str_replace(",", " ", $tago); $tago = str_replace("]", " ", $tago); $tago = str_replace("[", " ", $tago); $tago = str_replace("!", " ", $tago); $tago = str_replace('"', ' ', $tago); $tago = str_replace("_", " ", $tago); $tago = str_replace("/", " ", $tago); $tago = str_replace("@", " ", $tago); $tago = str_replace("$", " ", $tago); $tago = str_replace("%", " ", $tago); $tago = str_replace("^", " ", $tago); $tago = str_replace("~", " ", $tago); $tago = str_replace("*", " ", $tago); $tago = str_replace("'", " ", $tago); $tago = str_replace("|", " ", $tago); $tago = str_replace("+", " ", $tago); $tago = str_replace(":", " ", $tago); $tago = str_replace("?", " ", $tago); $tago = str_replace("#", " ", $tago); $tago = str_replace(".", " ", $tago); $tago = str_replace("}", " ", $tago); $tago = str_replace("{", " ", $tago); $tago = str_replace("amp;", "and", $tago); $tago = preg_replace('/https|http|www/', " ", $tago); $tago = implode(' ',array_filter(explode('-',$tago))); return strtolower($tago); }
function potong_kata($oldstring, $wordsreturned) { $retval = $string; $string = preg_replace('/(?<=\S,)(?=\S)/', ' ', $oldstring); $string = str_replace("\n", " ", $string); $array = explode(" ", $string); if (count($array)<=$wordsreturned) { $retval = $string; } else { array_splice($array, $wordsreturned); $retval = implode(" ", $array); } return $retval; }
...
function jsencode($code){
    $idimgx = str_replace('=', '', base64_encode(urlencode($code)));
    $idimgx = str_rot13($idimgx);
    return $idimgx;
}
function jsdecode($code){
    $idimgx = urldecode(base64_decode(str_rot13($code)));
    return $idimgx;
}
