<?php
namespace GetIPIntel;
class GetIPIntelChecker {
/*
...
*/
	...
	function checkProxy($contactEmail, $ip){
			...
			if ($response > $banOnProbability) {
				/* A Proxy / VPN / bad IP has been detected based on your criteria
				...
				if ($response < 0 || strcmp($response, "") == 0 ) {
					...
					//let visitor pass if the server return error
					return true;
				}
				return true;
			}
