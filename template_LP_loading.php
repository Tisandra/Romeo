                    ...
                    <article itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
                        <div class="gmr-box-content gmr-single">
                            ...
                            <header class="entry-header">
                                <h1 class="entry-title" itemprop="headline" style="font-size:20px;"><?php echo $title; ?></h1>
                            </header>
								
								<div style="display:block;width:100%;position:relative;margin-bottom:5px;margin-top:2px;text-align:center;">
<p><strong>Please Wait… Download link is in progress ….</strong></p>
<style>#myProgress {
  width: 100%;
...
<div id="myProgress">
  <div id="myBar" style="width:1%;">wait...</div>
</div>
<br>
<div style="color:red; display:none;" id="hiddenText">
    <center>
        <h3><strong>Your Link Is Ready</strong></h3>
        <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi6VFQ1Ns92nPtvqqZhPDfG5SQaPJsrmLm4QOVwmSMx2p5Wg3fT3M9fxq9T8RBuaGjm_QIg5RFgZw37iTXslO-Cdla4ZT0mqGCyW8xpqx5RgOR2q4OcTBjqXFQzkyR8zW6Swp9Kok5nGO9tmc-2o9Lqngbh0gWcgnHUrtPKQ9TQ0Q_K_QrSChgd318/s16000/down3.gif" alt="<?php echo $title; ?>" />
    </center>
</div>
							...
							<div style="display:block;width:100%;position:relative;margin-bottom:5px;margin-top:5px;text-align:center;">
                                    ...
                                    <a href="<?php echo $target_url; ?>"><h2 style="text-align: center;font-size: 16px;margin-top: 15px;margin-bottom: 55px;">
